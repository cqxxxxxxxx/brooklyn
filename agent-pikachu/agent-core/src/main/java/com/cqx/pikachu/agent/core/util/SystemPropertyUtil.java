...
public class SystemPropertyUtil {
    ...
    private static final Logger logger = Logger.getLogger(SystemPropertyUtil.class);
    ...
    public static String get(final String key, String def) {
        ...
        try {
            ...
            logger.warn("Unable to retrieve a system property " + key + "; default values will be used.");
        }
